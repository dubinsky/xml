...
private[xml] trait XmlAstDsl[ELEMENT]:
  ...
  // One function per [[XmlElement]], named by local name. `object` and `var` are keywords.
  def a(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.A, mods)
  def abbr(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Abbr, mods)
  def area(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Area, mods)
  def article(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Article, mods)
  def aside(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Aside, mods)
  def b(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.B, mods)
  def base(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Base, mods)
  def bdi(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Bdi, mods)
  def bdo(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Bdo, mods)
  ...
  def cite(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Cite, mods)
  def code(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Code, mods)
  def col(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Col, mods)
  ...
  def del(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Del, mods)
  def details(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Details, mods)
  def dfn(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Dfn, mods)
  ...
  def embed(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Embed, mods)
  ...
  def hr(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Hr, mods)
  def html(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Html, mods)
  def i(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.I, mods)
  def iframe(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Iframe, mods)
  ...
  def kbd(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Kbd, mods)
  ...
  def mark(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Mark, mods)
  ...
  def `object`(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Object, mods)
  ...
  def q(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Q, mods)
  def s(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.S, mods)
  def samp(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Samp, mods)
  def script(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Script, mods)
  def small(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Small, mods)
  def source(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Source, mods)
  def span(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Span, mods)
  def strong(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Strong, mods)
  def style(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Style, mods)
  def sub(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Sub, mods)
  def summary(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Summary, mods)
  def sup(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Sup, mods)
  ...
  def track(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Track, mods)
  def u(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.U, mods)
  def ul(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Ul, mods)
  def `var`(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Var, mods)
  def video(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Video, mods)
  def wbr(mods: Conversion.into[XmlMod]*): Element = tagged(XmlElement.Wbr, mods)
